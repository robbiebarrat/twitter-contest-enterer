...
bannedusers = ['bot', 'spot', 'lvbroadcasting', 'jflessauSpam', 'bryster125', 'MobileTekReview'] # does not need to be the entire username! you can just put 'bot' for names like 'b0tspotter', etc.
